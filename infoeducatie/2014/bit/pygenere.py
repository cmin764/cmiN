...
test = Vigenere("I'm happy that you're coming with me to Galaciuc, I hope we will have a wonderfull time there.".upper())
#print test.encipher('LIME')
test = VigCrack("J'a vbxtz hvbb cpi'ff ksnwbh emuv af bs Hozbkmvq, W iwtf ks xqpm vowm e xcbemvgizm bmns himvf.".upper())
#print test.crack_codeword(4)
#print test.crack_message(4)
